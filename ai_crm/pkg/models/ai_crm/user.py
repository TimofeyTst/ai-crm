...
class UserFields:
    ...
    first_name: str | None = Field(
        description="User first name.", example="Moscow"
    )
    last_name: str | None = Field(
        description="User last name.", example="Moscow"
    )
    is_active: bool = Field(description="User is active.", example=True)
    created_at: datetime = Field(
        description="User created at.", example=datetime.now()
    )
    updated_at: datetime = Field(
        description="User updated at.", example=datetime.now()
    )
