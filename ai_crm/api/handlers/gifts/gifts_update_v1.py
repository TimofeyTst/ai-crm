...
async def handle(context: web_context.WebContext, request: gift_models.GiftUpdateRequest) -> gift_models.Gift:
    return await gifts_service.update_gift(context, request)
